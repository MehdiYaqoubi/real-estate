...
def create_sample():
    ...
    house_sell = HouseSell(
        has_yard=True, floor_count=3, user=Users.objects_list[2], area=400,
        room_count=4, built_year=1380, region=reg1, address='Some text...',
        price_per_meter=20, discountable=True, convertible=True
    )

    # HouseRent
    house_rent = HouseRent(
        has_yard=True, floor_count=2, user=Users.objects_list[3], area=200,
        room_count=2, built_year=1385, region=reg1, address='Some text...',
        initial_price=90, monthly_price=2.5, discountable=True, convertible=True
    )

    # StoreSell
    store_sell = StoreSell(
        user=Users.objects_list[1], area=30, room_count=0, built_year=1390,
        region=reg1, address='Some text...', price_per_meter=20,
        discountable=True
    )
    ...
    store_rent = StoreRent(
        ...
        region=reg1, address='Some text...', initial_price=500,
        monthly_price=1.5, discountable=True,
        convertible=True
    )
